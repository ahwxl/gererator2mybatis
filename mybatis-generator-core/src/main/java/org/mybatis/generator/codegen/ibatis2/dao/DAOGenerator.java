...
import org.mybatis.generator.codegen.ibatis2.dao.elements.SelectForPageMethodGenerator;
...
public class DAOGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
       ...
       addCountByExampleMethod(topLevelClass, interfaze);
        ...
        addSelectForPageMethod(topLevelClass, interfaze);
    ...
    protected TopLevelClass getTopLevelClassShell() {
        ...
        FullyQualifiedJavaType extendType = new FullyQualifiedJavaType(
                "com.bplow.netconn.base.dao.BaseIbatisDaoSupport");
        ...
        answer.addImportedType(extendType);
        answer.addSuperInterface(interfaceType);
        answer.addImportedType(interfaceType);
        answer.setSuperClass(extendType);
        answer.addImportedType(pageType);
...
//        }
    ...
    protected void addSelectForPageMethod(TopLevelClass topLevelClass, Interface interfaze){
    	AbstractDAOElementGenerator methodGenerator = new SelectForPageMethodGenerator();
    	initializeAndExecuteGenerator(methodGenerator, topLevelClass,
                interfaze);
