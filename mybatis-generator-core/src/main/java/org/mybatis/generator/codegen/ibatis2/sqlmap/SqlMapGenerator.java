...
import org.mybatis.generator.codegen.ibatis2.sqlmap.elements.CountForPageElementGenerator;
...
import org.mybatis.generator.codegen.ibatis2.sqlmap.elements.SelectForPageElementGenerator;
...
public class SqlMapGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addSelectForPageElement(answer);
        addCountForPageElement(answer);
	 ...
	 * @param answer
	 */
	private void addCountForPageElement(XmlElement parentElement) {
		CountForPageElementGenerator elementGenerator = new CountForPageElementGenerator();
	 ...
	 * @param answer
	 */
	private void addSelectForPageElement(XmlElement parentElement) {
		SelectForPageElementGenerator elementGenerator = new SelectForPageElementGenerator();
		initializeAndExecuteGenerator(elementGenerator, parentElement);
	}
